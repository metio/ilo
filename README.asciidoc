...
[source,shell]
----
$ curl --location https://github.com/metio/ilo/releases/download/2.0.0/ilo-linux --output ilo
$ mv ilo ~/bin/ilo
$ chmod +x ~/bin/ilo
----
...
[source,shell]
----
$ curl --location https://github.com/metio/ilo/releases/download/2.0.0/ilo-2.0.0.zip --output ilo.zip
$ unzip ilo.zip
$ ln --symbolic --relative ilo-2.0.0/bin/ilo ~/bin/ilo
----
